...
class FlowLayoutPage extends StatelessWidget {
  const FlowLayoutPage({Key? key}) : super(key: key);
...
class _WrapLayout extends StatelessWidget {
  const _WrapLayout({Key? key}) : super(key: key);
...
class _FlowLayout extends StatelessWidget {
  const _FlowLayout({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Flow(
      delegate: _TestFlowDelegate(margin: const EdgeInsets.all(10.0)), // 现实代理
      children: <Widget>[
        Container(
          width: 80.0,
          height: 80.0,
